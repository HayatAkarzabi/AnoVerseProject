...
<body>
<%
    // Récupérer la séance à partir de l'attribut de requête
    Long id  = Long.parseLong(request.getParameter("id"));
    ImplISeance implISeance = new ImplISeance();

    Seance seance = implISeance.chercherSeance(id);

    if (seance == null) {
        // Rediriger vers la liste des séances si aucune séance n'est trouvée
        response.sendRedirect(request.getContextPath() + "/vues/listSeances.jsp?error=no_seance_to_edit");
        return;
    }

    // Formater la date et l'heure pour les champs de formulaire
    DateTimeFormatter dateFormatter = DateTimeFormatter.ofPattern("yyyy-MM-dd");
    DateTimeFormatter timeFormatter = DateTimeFormatter.ofPattern("HH:mm");

    String formattedDate = seance.getDate().format(dateFormatter);
    String formattedTime = seance.getDate().format(timeFormatter);
%>

<div class="container my-5">
    <div class="card shadow-lg">
        <div class="card-header bg-primary text-white">
            <h3 class="mb-0"><i class="fas fa-edit me-2"></i>Modifier la séance</h3>
        </div>
        <div class="card-body">
            ...
            <form action="../updateSeance" method="post" id="seanceForm">
                ...
                <div class="step-container active" id="step1">
                    ...
                    <div class="row row-cols-1 row-cols-md-3 g-4">
                        <%
                            ...
                            if(films != null && !films.isEmpty()) {
                                for(Film film : films) {
                                    boolean isSelected = film.getId().equals(seance.getFilm().getId());
                        %>
                        <div class="col">
                            <div class="card film-card h-100 <%= isSelected ? "selected" : "" %>" onclick="selectFilm('<%= film.getId() %>', this)">
                    ...
                    <input type="hidden" name="filmId" id="selectedFilmId" value="<%= seance.getFilm().getId() %>">

                    <div class="mt-4 text-end">
                        <button type="button" class="btn btn-primary" onclick="goToStep(2)" id="step1Next">
                ...
                <div class="step-container" id="step2">
                        ...
                        <%
                            ...
                            if(salles != null && !salles.isEmpty()) {
                                for(Salle salle : salles) {
                                    boolean isSelected = salle.getId().equals(seance.getSalle().getId());
                        %>
                        <div class="col">
                            <div class="card salle-card text-center <%= isSelected ? "selected" : "" %>" onclick="selectSalle('<%= salle.getId() %>', this)">
                                <div class="card-body">
                    ...
                    <input type="hidden" name="salleId" id="selectedSalleId" value="<%= seance.getSalle().getId() %>">
                ...
                <div class="step-container" id="step3">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="date" class="form-control" id="seanceDate" name="seanceDate" value="<%= formattedDate %>" required>
                        </div>
                        <div class="col-md-6">
                            <label for="seanceTime" class="form-label">Heure</label>
                            <input type="time" class="form-control" id="seanceTime" name="seanceTime" value="<%= formattedTime %>" required>
                        </div>
                    </div>
        ...
        <div class="card-footer">
            <a href="listSeances.jsp" class="btn btn-outline-secondary">
                <i class="fas fa-list me-1"></i> Retour à la liste des séances
            </a>
        </div>
    </div>
</div>
